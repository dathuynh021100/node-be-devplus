...
exports.update = (req, res) => {
  ...
  Campus.findByIdAndUpdate(id, req.body, { useFindAndModify: false })
    .then((data) => {
      if (!data) {
        res.status(404).send({
...
exports.delete = (req, res) => {
  ...
  Campus.findByIdAndRemove(id, { useFindAndModify: false })
    .then((data) => {
      if (!data) {
        res.status(404).send({
